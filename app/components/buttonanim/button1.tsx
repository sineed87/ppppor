  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        linkHover1:
          "relative after:absolute after:bg-white after:bottom-2 after:h-[0.5px] after:w-3/3 after:origin-bottom-left after:scale-x-200 hover:after:origin-bottom-right hover:after:scale-x-0 after:transition-transform after:ease-in-out after:duration-300", // White underline
        linkHover2:
          "relative after:absolute after:bg-white after:bottom-2 after:h-[0.5px] after:w-2/3 after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300", // White underline
      },
      size: {
